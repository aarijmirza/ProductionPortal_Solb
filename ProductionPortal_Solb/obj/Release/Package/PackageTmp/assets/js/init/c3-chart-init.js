...
$(document).ready(function() {    
	...
	function xpScatterPlotChart() {		
		var xpScatterPlotChart = c3.generate({
			...
			color: { pattern: ["#ff4b5b", "#2bcd72", "#a6173f"] },
			data: {
				xs: {
					setosa: 'setosa_x',
	...
	function xpStackedBarChart() {
		var xpStackedBarChart = c3.generate({
			...
			color: { pattern: ["#e1e4e9", "#a6173f", "#2bcd72"] },
			data: {
				columns: [
	...
	function xpCombinationChart() {
		var xpCombinationChart = c3.generate({
			...
			color: { pattern: ["#a6173f", "#e1e4e9", "#ff4b5b", "#fac751", "#2bcd72", "#52c4ca"] },
			data: {
				columns: [
	...
	function xpGaugeChart() {
		var xpGaugeChart = c3.generate({
			...
			color: {
				pattern: ['#fac751', '#ff4b5b', '#2bcd72', '#a6173f'],
				threshold: {
					values: [30, 60, 90, 100]
				}
			},
	...
	function xpPieChart() {
		var xpPieChart = c3.generate({
			bindto: '#xp-c3-pie',
			color: { pattern: ["#a6173f", "#e1e4e9", "#2bcd72"] },
			data: {
				columns: [
					['SeriesA', 40],
					['SeriesB', 25],
