 !function($) {
  "use strict";
      ...
      var switchery = new Switchery(primary, { color: '#a6173f' });
      ...
      var switchery = new Switchery(primary_small, { color: '#a6173f', size: 'small' });
      ...
      var switchery = new Switchery(primary_large, { color: '#a6173f', size: 'large' });
      ...
      var switchery = new Switchery(primary_multicolor, { color: '#a6173f', jackColor: '#dbe5fd' });
      ...
      var switchery = new Switchery(primary_multicolor_on_off, { color: '#a6173f', secondaryColor: '#949ca9', jackColor: '#dbe5fd', jackSecondaryColor: '#e9eaed' });

      var secondary_multicolor_on_off = document.querySelector('.js-switch-secondary-multicolor-on-off');
      var switchery = new Switchery(secondary_multicolor_on_off, { color: '#949ca9', secondaryColor: '#a6173f', jackColor: '#e9eaed', jackSecondaryColor: '#dbe5fd' });
