    ...
    var xpLineDiffPoint = new Chart(xpLineDiffPointID, {
        ...
        data: {
            ...
            datasets: [{
                ...
                pointBackgroundColor: ["#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f"],
                fill: false,
                borderDash: [5, 5],
                pointRadius: 15,
                pointHoverRadius: 20,
    ...
    var xpLinechartID = document.getElementById("xp-chartjs-basic-line").getContext('2d');
        var xpLineChart = new Chart(xpLinechartID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["#a6173f"],
                    borderColor: ["#a6173f"],
                    pointBorderColor: ["#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f"],
        ...
        var xpScatterChart = new Chart(xpScatterChartID, {
            ...
            data: {
                datasets: [{
                    ...
                    pointBorderColor: ["#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f"],
        ...
        var xpBarChart = new Chart(xpBarChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#a6173f", "#a6173f", "#a6173f", "#a6173f", "#a6173f", "#a6173f", "#a6173f"],
                        borderColor: ["#a6173f", "#a6173f", "#a6173f", "#a6173f", "#a6173f", "#a6173f", "#a6173f"],
                        borderWidth: 1,
        ...
        var xpMultiAxisBarChart = new Chart(xpMultiAxisBarChartID, {
            type: 'bar',
                data: {
                    ...
                    datasets: [{
                        label: 'Series A',
                        backgroundColor: ["#a6173f","#ff4b5b","#2bcd72","#fac751","#52c4ca","#949ca9","#313131"],
                        yAxisID: 'y-axis-1',
        ...
        var xpDatasetArea = new Chart(xpDatasetAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["rgba(76,124,243,0.5)"],
                    borderColor: ["#a6173f"],
                    pointBorderColor: ["#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f"],
                    pointBackgroundColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBorderWidth: 2,                                               
        ...
        var xpRadarArea = new Chart(xpRadarAreaID, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: ["#a6173f"],
                    pointBorderColor: ["#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff","#ffffff"],
                    pointBackgroundColor: ["#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f","#a6173f"],
                    pointBorderWidth: 1,
        ...
        var xpDoughnutChart = new Chart(xpDoughnutChartID, {
            ...
            data: {
                datasets: [{
                    data: [40,35,25],
                    backgroundColor: ["#a6173f","#2bcd72","#e1e4e9"],
                    label: 'Dataset 1'
                }],
