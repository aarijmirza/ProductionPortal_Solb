...
$(document).ready(function() {    
    ...
    $.fn.editableform.buttons='<button type="submit" class="btn btn-success editable-submit btn-sm"><i class="mdi mdi-check"></i></button><button type="button" class="btn btn-danger editable-cancel btn-sm"><i class="mdi mdi-close"></i></button>';
     ...
     $('#xp-xeditable-username').editable({
        type: 'text',
        pk: 1,  
    ...
    $('#xp-xeditable-firstname').editable({
        type: 'text',
        pk: 1, 
        placement: 'right',
    ...
    $('#xp-xeditable-sex').editable({
        ...
        display: function(value, sourceData) {
             var colors = {"": "#777777", 1: "#2bcd72", 2: "#a6173f"},
    ...
    $('#xp-xeditable-comments').editable({
        title: 'Enter comments',
        rows: 5,
        inputclass: 'form-control form-control-sm'
    });
     
    $('#xp-xeditable-checklist').editable({
        type: 'checklist',
        pk: 1,  
