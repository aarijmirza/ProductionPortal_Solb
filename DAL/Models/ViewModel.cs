...
namespace DAL.Models
{
    public class ViewModel
    {
        ...
        public class RMBundlesVM
        {
            ...
            public List<RMBundlingQCRowBLL> BundlingList { get; set; }
            public RMQCInspectionBLL Inspection { get; set; }
        }
        ...
        public class DelayCounterMeasureVM
        {
            ...
            public DAL.Models.PlantDelayBLL DelayDetail { get; set; }

            public List<DAL.Models.DelayCounterMeasureBLL>
                CounterMeasures
            { get; set; }
